			...
			if ($check == 0 ) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) >1 ) {
						...
						$result = mysqli_query($con, "INSERT INTO user (firstName,lastName,email,address,password,confirmCode) VALUES ('$_POST[first_name]','$_POST[last_name]','$_POST[email]','$_POST[signupaddress]','$_POST[password]','$confirmCode')");
										...
										<div>
											<form action="" method="POST" class="registration">
												<div class="signup_form">
													...
													<div>
														<td>
															<input name="signupaddress" placeholder="Write Your Wallet Address" required="required" class="email signupbox" type="text" size="30" value="'.$u_address.'">
														</td>
													</div>
													<div>
														<td>

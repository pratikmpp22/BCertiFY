		...
		<div class="categolis">
			<table>
				<tr>
					...
					<th><?php echo '<a href="reset.php?uid='.$user.'" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Reset Password</a>'; ?></th>
